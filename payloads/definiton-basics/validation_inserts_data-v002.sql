...
-- Empty path (no nodes) - CRITICAL for blocking execution
INSERT INTO tb_validation_outcomes (
    validation_test_id, object_type, tag_type, tag_code, tag
) VALUES (
    (SELECT id FROM tb_validation_tests WHERE code = 'PATH_CONN_001'),
...
-- Empty path (no nodes) - QA for review and reporting
INSERT INTO tb_validation_outcomes (
    validation_test_id, object_type, tag_type, tag_code, tag
) VALUES (
    (SELECT id FROM tb_validation_tests WHERE code = 'PATH_CONN_001'),
...
-- Single node path - RISK for operational flagging
INSERT INTO tb_validation_outcomes (
    validation_test_id, object_type, tag_type, tag_code, tag
) VALUES (
    (SELECT id FROM tb_validation_tests WHERE code = 'PATH_CONN_001'),
...
-- Single node path - QA for data quality review
INSERT INTO tb_validation_outcomes (
    validation_test_id, object_type, tag_type, tag_code, tag
) VALUES (
    (SELECT id FROM tb_validation_tests WHERE code = 'PATH_CONN_001'),
    ...
    'QA',
    'UNUSUAL_LENGTH',
    'QA_PATH_UNUSUAL_LENGTH'
);

-- Path requires manual review due to minimal length
INSERT INTO tb_validation_outcomes (
    validation_test_id, object_type, tag_type, tag_code, tag
) VALUES (
    (SELECT id FROM tb_validation_tests WHERE code = 'PATH_CONN_001'),
